...
function UserRepos({repos}) {
  ...
  return (
    <div style={darkMode ? {background:'#2B3549'} : {}} className='user-repos'>
        {slicedRepos?.map((repo) => (
            <div style={darkMode ? {background:'#2B3549'} : {}} className={darkMode ? 'repo-container color-dark' : 'repo-container color-light'}>
